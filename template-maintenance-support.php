...
<div class="lg:col-span-6"><img alt="WordPress theme code on a laptop with responsive device testing on a desk" class="w-full h-full object-cover rounded-[2rem] shadow-[0_24px_60px_rgba(26,28,30,0.12)] aspect-[5/4]" src="<?php echo esc_url( get_template_directory_uri() . '/images/wordpress-responsive-testing.webp' ); ?>"/></div>
</div>
</section>
